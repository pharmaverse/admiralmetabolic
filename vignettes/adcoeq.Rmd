...
adsl <- dm %>%
  ...
  derive_vars_merged(dataset_add = admiral_adsl,
...
time-windows, see `{admiral}` [Visit and Period Variables](https://pharmaverse.github.io/admiral/articles/visits_periods.html).
...
describes further steps like how to calculate the change from baseline variables or how to add parameters for questionnaire completion.
