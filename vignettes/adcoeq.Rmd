...
adcoeq4 <- adcoeq3 %>%
  ...
  # The decision on how to populate pre-baseline and baseline values of CHG is left to producer's choice
  restrict_derivation(
    derivation = derive_var_chg,
    filter = AVISITN > 0
  ) %>%
  # Calculate PCHG for post-baseline records
  # The decision on how to populate pre-baseline and baseline values of PCHG is left to producer's choice
  restrict_derivation(
